        ...
        >
            <ScrollView contentContainerStyle={styles.scrollView}>
                <View style={{ padding: 10 }}>
                    ...
                    <Button textColor="white" buttonColor="pink" style={{ margin: 10 }} mode="contained" onPress={handleUploadImage}>
                        Upload Image
                    </Button>
                    {imagePath !== "" && (
                    ...
                    <TextInput
                        ...
                        style={styles.textInput}
                    />
                    <Button buttonColor="pink" textColor="white" mode="contained" onPress={handleAddNewService}>Add</Button>
                </View>
            </ScrollView>
        </KeyboardAvoidingView>
    )
